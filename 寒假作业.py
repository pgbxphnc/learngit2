...
if __name__ == '__main__':
    ...
    train(lenet, train_loader_multi, criterion, optimizer, epochs=5)
    ...
    train(lenet, train_loader_single, criterion, optimizer, epochs=5)
    ...
    train(resnet34, train_loader_multi, criterion, optimizer, epochs=5)
    ...
    train(resnet34, train_loader_single, criterion, optimizer, epochs=5)
